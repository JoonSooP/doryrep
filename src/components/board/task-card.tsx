...
export function TaskCard({
  ...
  return (
    <div
      ...
      className={`bg-white rounded-lg border p-3 mb-2 shadow-sm hover:shadow-md transition-shadow ${canEdit ? "cursor-grab active:cursor-grabbing" : ""}`}
    >
      ...
      {task.assignee && (
        <div className="mt-2 flex items-center gap-1">
          <span className="w-5 h-5 rounded-full bg-blue-100 text-blue-700 text-[10px] flex items-center justify-center font-medium">
